  ...
  <div class="wrapper">
        <div class="sidebar">
            ...
            <ul style="padding-left: 0rem">
                ...
                <li><a style="text-decoration: none;" href="#"><i class="fas fa-address-card"></i>PayBill</a></li>
                <li><a style="text-decoration: none;" href="#"><i class="fas fa-project-diagram"></i>Area Info</a></li>
